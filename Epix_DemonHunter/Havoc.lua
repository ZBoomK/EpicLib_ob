...
local function v2(v4, ...)
	...
	local v6;
	while true do
		if ((0 == v5) or (1223 >= 4525)) then
			v6 = v0[v4];
			if ((1090 <= 4827) and not v6) then
				return v1(v4, ...);
			end
			v5 = 1;
		end
		if ((v5 == 1) or (239 > 1345)) then
			return v6(...);
		end
	end
end
v0[LUAOBFUSACTOR_DECRYPT_STR_0("\244\211\210\61\217\159\194\19\222\205\243\48\232\175\194\12\238\235\218\51\233\184\137\18\196\194", "\126\177\163\187\69\134\219\167")] = function(...)
	...
	v10:RegisterForEvent(function()
		local v123 = 0;
		while true do
			if ((v123 == 3) or (3710 >= 3738)) then
				v108 = 11111;
				break;
			end
			if ((v123 == 0) or (3838 < 2061)) then
				v97 = false;
				v98 = false;
				v123 = 1;
			end
			if ((2 == v123) or (690 > 1172)) then
				v101 = false;
				v107 = 11111;
				v123 = 3;
			end
			if ((v123 == 1) or (1592 > 2599)) then
				v99 = false;
				v100 = false;
				v123 = 2;
			end
	...
	v10:RegisterForEvent(function()
		local v124 = 0;
		while true do
			if ((3574 <= 4397) and (v124 == 0)) then
				v89 = v14:GetEquipment();
				v90 = (v89[13] and v19(v89[13])) or v19(0);
				v124 = 1;
			end
			if ((3135 > 1330) and (v124 == 1)) then
	...
	local function v112()
		local v127 = 0;
		while true do
			if ((v127 == 0) or (3900 <= 3641)) then
				v32 = v26.HandleTopTrinket(v88, v35, 40, nil);
				if ((1724 == 1724) and v32) then
					return v32;
				end
				v127 = 1;
			end
			if ((455 <= 1282) and (v127 == 1)) then
				v32 = v26.HandleBottomTrinket(v88, v35, 40, nil);
				if ((4606 < 4876) and v32) then
					return v32;
				end
				break;
			end
	...
	local function v113()
		local v128 = 0;
		while true do
			if ((v128 == 0) or (1442 > 2640)) then
				if ((136 < 3668) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\142\165\4\86", "\175\204\201\113\36\214\139")]:IsCastable() and v65 and (v14:HealthPercentage() <= v67)) then
					if (v24(v85.Blur) or (1784 > 4781)) then
						return LUAOBFUSACTOR_DECRYPT_STR_0("\69\192\32\206\68\67\201\51\217\10\84\197\35\217", "\100\39\172\85\188");
					end
				end
				if ((4585 > 3298) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\131\125\173\136\54\191\111\184\140\56", "\83\205\24\217\224")]:IsCastable() and v66 and (v14:HealthPercentage() <= v68)) then
					if (v24(v85.Netherwalk) or (1664 > 1698)) then
			...
			if ((v128 == 1) or (3427 < 2849)) then
				if ((3616 <= 4429) and v86[LUAOBFUSACTOR_DECRYPT_STR_0("\150\247\192\206\46\198\161\106\177\252\196", "\30\222\146\161\162\90\174\210")]:IsReady() and v80 and (v14:HealthPercentage() <= v82)) then
					if ((3988 >= 66) and v24(v87.Healthstone)) then
						return LUAOBFUSACTOR_DECRYPT_STR_0("\237\75\113\6\241\70\99\30\234\64\117\74\225\75\118\15\235\93\121\28\224", "\106\133\46\16");
					end
				end
				if ((v79 and (v14:HealthPercentage() <= v81)) or (862 > 4644)) then
					local v181 = 0;
					while true do
						if ((1221 == 1221) and (v181 == 0)) then
							if ((v83 == LUAOBFUSACTOR_DECRYPT_STR_0("\106\37\117\238\95\83\80\41\125\251\26\104\93\33\127\245\84\71\24\16\124\232\83\79\86", "\32\56\64\19\156\58")) or (45 > 1271)) then
								if ((3877 > 1530) and v86[LUAOBFUSACTOR_DECRYPT_STR_0("\104\205\227\68\95\225\136\83\198\226\126\95\243\140\83\198\226\102\85\230\137\85\198", "\224\58\168\133\54\58\146")]:IsReady()) then
									if (v24(v87.RefreshingHealingPotion) or (4798 == 1255)) then
							...
							if ((v83 == "Dreamwalker's Healing Potion") or (2541 > 2860)) then
								if (v86[LUAOBFUSACTOR_DECRYPT_STR_0("\255\153\20\244\180\203\206\215\128\20\231\170\244\202\218\135\24\251\190\236\192\207\130\30\251", "\175\187\235\113\149\217\188")]:IsReady() or (2902 > 3629)) then
									if ((427 < 3468) and v24(v87.RefreshingHealingPotion)) then
	...
	local function v114()
		local v129 = 0;
		while true do
			if ((4190 >= 2804) and (v129 == 2)) then
				if ((2086 == 2086) and v15:IsInMeleeRange(5) and v42 and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\127\43\185\89\67\72\12\189\66\72", "\45\59\78\212\54")]:IsCastable() or v85[LUAOBFUSACTOR_DECRYPT_STR_0("\52\83\142\132\136\12\161\241\20\83\144", "\144\112\54\227\235\230\78\205")]:IsAvailable())) then
					if ((4148 > 2733) and v24(v85.DemonsBite, not v15:IsInMeleeRange(5))) then
			...
			if ((3054 >= 1605) and (v129 == 1)) then
				if ((1044 < 1519) and not v15:IsInMeleeRange(5) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\26\52\5\185\21\234\37\48", "\85\92\81\105\219\121\139\65")]:IsCastable()) then
					if ((1707 <= 4200) and v24(v85.Felblade, not v15:IsSpellInRange(v85.Felblade))) then
			...
			if ((3970 == 3970) and (v129 == 0)) then
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\98\222\181\67\23\124\95\218\183\66\58\104\89\210", "\29\43\179\216\44\123")]:IsCastable() and v49) or (98 == 208)) then
					if ((2006 <= 3914) and v24(v85.ImmolationAura, not v15:IsInRange(v31))) then
				...
				if ((v50 and not v14:IsMoving() and (v94 > 1) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\50\238\79\86\127\46\225\110\83\114\12\226", "\19\97\135\40\63")]:IsCastable()) or (3101 <= 2971)) then
					if ((v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\190\80\50\34\42\35", "\81\206\60\83\91\79")) or v85[LUAOBFUSACTOR_DECRYPT_STR_0("\109\164\222\113\42\205\89\182\79\191\213\118\28\202\74\173\66\184", "\196\46\203\176\18\79\163\45")]:IsAvailable() or (2073 <= 671)) then
						if ((3305 > 95) and v24(v87.SigilOfFlamePlayer, not v15:IsInRange(v31))) then
					...
					elseif ((2727 == 2727) and (v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\169\221\31\216\202\177", "\129\202\168\109\171\165\195\183"))) then
						if (v24(v87.SigilOfFlameCursor, not v15:IsInRange(40)) or (2970 >= 4072)) then
	...
	local function v115()
		if ((3881 > 814) and v14:BuffDown(v85.FelBarrage)) then
			local v139 = 0;
			while true do
				if ((v139 == 0) or (4932 < 4868)) then
					if ((3667 <= 4802) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\106\130\226\57\70\180\244\40\75\151", "\77\46\231\131")]:IsReady() and v41) then
						if ((1260 >= 858) and v24(v85.DeathSweep, not v15:IsInRange(v31))) then
					...
					if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\111\25\63\161\249\185\73\91\90\30\62\166", "\58\46\119\81\200\145\208\37")]:IsReady() and v37) or (3911 == 4700)) then
						if ((3000 < 4194) and v24(v85.Annihilation, not v15:IsSpellInRange(v85.Annihilation))) then
	...
	local function v116()
		...
		local v131;
		while true do
			if ((651 < 4442) and (v130 == 2)) then
				if ((v57 and not v14:IsMoving() and ((v35 and v60) or not v60) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\169\241\85\33\27\77\116\168\248\79\32\23\73", "\26\236\157\44\82\114\44")]:IsCastable() and (v15:DebuffDown(v85.EssenceBreakDebuff)) and (v94 > v64)) or (195 >= 1804)) then
					if ((v63 == LUAOBFUSACTOR_DECRYPT_STR_0("\58\34\212\66\47\60", "\59\74\78\181")) or (1382 > 2216)) then
						if (v24(v87.ElysianDecreePlayer, not v15:IsInRange(v31)) or (2861 == 2459)) then
					...
					elseif ((1903 < 4021) and (v63 == LUAOBFUSACTOR_DECRYPT_STR_0("\180\240\107\230\230\217", "\171\215\133\25\149\137"))) then
						if (v24(v87.ElysianDecreeCursor, not v15:IsInRange(30)) or (2270 >= 4130)) then
				...
				if ((2593 <= 3958) and (v76 < v108)) then
					if ((1176 == 1176) and v77 and ((v35 and v78) or not v78)) then
						local v188 = 0;
						while true do
							if ((v188 == 0) or (3062 == 1818)) then
								v32 = v112();
								if (v32 or (3717 < 3149)) then
									return v32;
								end
								break;
							end
			...
			if ((3195 < 3730) and (v130 == 0)) then
				if ((2797 <= 3980) and ((v35 and v61) or not v61) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\95\68\99\132\243\132\96\81\127\138\237\130\97", "\235\18\33\23\229\158")]:IsCastable() and v58 and not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\116\191\204\180\94\179\194", "\219\48\218\161")]:IsAvailable()) then
					if ((1944 <= 2368) and v24(v87.MetamorphosisPlayer, not v15:IsInRange(v31))) then
	...
	local function v117()
		local v132 = 0;
		while true do
			if ((v132 == 6) or (3202 >= 4075)) then
				if ((64 == 64) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\227\208\85\48\192\255\75\62\222\206\66", "\95\183\184\39")]:IsCastable() and v51 and not v14:PrevGCDP(1, v85.VengefulRetreat) and not v14:IsMoving() and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\145\58\234\41\90\162\14\180\59\226\53", "\98\213\95\135\70\52\224")]:IsAvailable() or not v15:IsInRange(12)) and v15:DebuffDown(v85.EssenceBreakDebuff) and v15:IsSpellInRange(v85.ThrowGlaive) and not v14:HasTier(31, 2)) then
					if ((2202 >= 694) and v24(v85.ThrowGlaive, not v15:IsSpellInRange(v85.ThrowGlaive))) then
			...
			if ((3706 <= 3900) and (v132 == 3)) then
				if ((2890 > 2617) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\29\189\46\233\56\177\55\239\59\190\2\243\38\177", "\134\84\208\67")]:IsCastable() and v49 and (v94 >= 2) and (v14:Fury() < 70) and v15:DebuffDown(v85.EssenceBreakDebuff)) then
					if (v24(v85.ImmolationAura, not v15:IsInRange(v31)) or (3355 > 4385)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\194\227\43\191\41\222\236\10\186\36\252\239", "\69\145\138\76\214")]:IsCastable() and not v14:IsMoving() and v50 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\81\193\144\164\186\23\126\220\167\140\188\19\99\220\136\155\166", "\118\16\175\233\233\223")]:IsAvailable() and (v14:FuryDeficit() >= 30)) or (4108 < 3934)) then
					if ((3499 >= 3439) and ((v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\155\136\52\162\235\153", "\29\235\228\85\219\142\235")) or v85[LUAOBFUSACTOR_DECRYPT_STR_0("\30\219\180\222\114\64\51\64\60\192\191\217\68\71\32\91\49\199", "\50\93\180\218\189\23\46\71")]:IsAvailable())) then
						if ((876 < 3303) and v24(v87.SigilOfFlamePlayer, not v15:IsInRange(v31))) then
					...
					elseif ((2922 <= 3562) and (v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\63\80\206\167\245\111", "\109\92\37\188\212\154\29"))) then
						if ((2619 >= 1322) and v24(v87.SigilOfFlameCursor, not v15:IsInRange(40))) then
				...
				if ((4133 >= 2404) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\46\74\49\172\40\110\233\15\19\84\38", "\110\122\34\67\195\95\41\133")]:IsReady() and v51 and not v14:PrevGCDP(1, v85.VengefulRetreat) and not v14:IsMoving() and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\70\190\78\70\197\118\176\73", "\182\21\209\59\42")]:IsAvailable() and (v95 >= (2 - v27(v85[LUAOBFUSACTOR_DECRYPT_STR_0("\145\66\215\20\46\171\164\99\205\15\46\169\164", "\222\215\55\165\125\65")]:IsAvailable()))) and v15:DebuffDown(v85.EssenceBreakDebuff) and not v14:HasTier(31, 2)) then
					if (v24(v85.ThrowGlaive, not v15:IsSpellInRange(v85.ThrowGlaive)) or (1433 == 2686)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\140\135\8\193\117\119\177\131\10\192\88\99\183\139", "\22\197\234\101\174\25")]:IsCastable() and v49 and (v14:BuffStack(v85.ImmolationAuraBuff) < v103) and v15:IsInRange(8) and (v14:BuffDown(v85.UnboundChaosBuff) or not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\24\58\167\211\99\161\211\165\37\53\170\207", "\230\77\84\197\188\22\207\183")]:IsAvailable()) and ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\208\25\203\243\128\160\228\60\246\26\231\233\158\160", "\85\153\116\166\156\236\193\144")]:Recharge() < v85[LUAOBFUSACTOR_DECRYPT_STR_0("\129\243\94\182\234\3\161\194\95\182\229\11", "\96\196\128\45\211\132")]:CooldownRemains()) or (not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\16\158\104\90\220\172\177\250\39\136\122\84", "\184\85\237\27\63\178\207\212")]:IsAvailable() and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\45\64\12\125\13\88\4", "\63\104\57\105")]:CooldownRemains() > v85[LUAOBFUSACTOR_DECRYPT_STR_0("\34\138\169\75\7\134\176\77\4\137\133\81\25\134", "\36\107\231\196")]:Recharge())))) or (4123 == 4457)) then
					if (v24(v85.ImmolationAura, not v15:IsInRange(v31)) or (3972 <= 205)) then
			...
			if ((v132 == 1) or (3766 < 1004)) then
				...
				if ((4001 > 3798) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\164\249\131\98\56\219\161\19\133\236", "\118\224\156\226\22\80\136\214")]:IsCastable() and v41 and v97 and (not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\103\253\74\133\76\237\92\162\80\235\88\139", "\224\34\142\57")]:IsAvailable() or (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\251\180\214\216\125\242\88\44\204\162\196\214", "\110\190\199\165\189\19\145\61")]:CooldownRemains() > (v104 * 2))) and v14:BuffDown(v85.FelBarrage)) then
					if (v24(v85.DeathSweep, not v15:IsInRange(v31)) or (4688 <= 4499)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\46\189\141\37\15\187\156", "\109\122\213\232")]:IsCastable() and v36 and v59 and (v76 < v108) and ((v35 and v62) or not v62) and v15:DebuffDown(v85.EssenceBreakDebuff) and ((v10.CombatTime() < 10) or (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\195\242\182\49\227\248\176\32\230\248\177\57\253", "\80\142\151\194")]:CooldownRemains() > 10)) and ((v94 == 1) or (v94 > 3) or (v108 < 10)) and ((v15:DebuffDown(v85.EssenceBreakDebuff) and (not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\37\211\101\69\12\211\100\107\2\220\114", "\44\99\166\23")]:IsAvailable() or v14:BuffUp(v85.FuriousGazeBuff) or v14:HasTier(31, 4))) or not v14:HasTier(30, 2)) and (v10.CombatTime() > 10)) or (1567 <= 319)) then
					if (v24(v85.TheHunt, not v15:IsSpellInRange(v85.TheHunt)) or (4583 == 3761)) then
						return LUAOBFUSACTOR_DECRYPT_STR_0("\104\255\44\9\59\177\114\227\105\59\50\173\114\183\120\100", "\196\28\151\73\86\83");
					end
				end
				if ((3454 > 1580) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\213\6\37\50\131\74\10\119\244\6", "\22\147\99\73\112\226\56\120")]:IsCastable() and v45 and ((v94 > 1) or ((v94 == 1) and (v14:FuryDeficit() < 20) and v14:BuffDown(v85.MetamorphosisBuff)))) then
					if (v24(v85.FelBarrage, not v15:IsInRange(v31)) or (1607 == 20)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\165\66\94\86\166\204\106\135\67\79\90\163\221", "\62\226\46\63\63\208\169")]:IsReady() and v48 and (v15:DebuffDown(v85.EssenceBreakDebuff) or (v94 > 1)) and v14:BuffDown(v85.FelBarrage)) or (962 >= 4666)) then
					if (v24(v85.GlaiveTempest, not v15:IsInRange(v31)) or (1896 == 1708)) then
			...
			if ((3985 >= 1284) and (v132 == 2)) then
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\49\26\60\252\222\167\174\17\0\59\250\216", "\194\112\116\82\149\182\206")]:IsReady() and v37 and v14:BuffUp(v85.InnerDemonBuff) and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\28\177\73\58\197\227\3", "\110\89\200\44\120\160\130")]:CooldownRemains() <= v14:GCD()) and v14:BuffDown(v85.FelBarrage)) or (1987 == 545)) then
					if (v24(v85.Annihilation, not v15:IsSpellInRange(v85.Annihilation)) or (4896 < 1261)) then
				...
				if ((23 < 3610) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\244\128\208\17\146\186\92", "\52\178\229\188\67\231\201")]:IsReady() and v36 and v47 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\12\78\93\1\249\72\54\44", "\67\65\33\48\100\151\60")]:IsAvailable() and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\250\254\171\250\246\222\234", "\147\191\135\206\184")]:CooldownRemains() < (v104 * 3)) and (v14:BuffRemains(v85.MomentumBuff) < 5) and v14:BuffDown(v85.MetamorphosisBuff)) then
					if (v24(v85.FelRush, not v15:IsSpellInRange(v85.ThrowGlaive)) or (3911 < 2578)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\19\80\246\50\118\207\59", "\174\86\41\147\112\19")]:IsCastable() and v44 and not v14:PrevGCDP(1, v85.VengefulRetreat) and ((v15:DebuffDown(v85.EssenceBreakDebuff) and ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\118\5\153\10\40\0\3\187\83\15\158\2\54", "\203\59\96\237\107\69\111\113")]:CooldownRemains() > (30 - (v27(v85[LUAOBFUSACTOR_DECRYPT_STR_0("\7\15\175\237\52\223\209\12\23\184\243\52\244", "\183\68\118\204\129\81\144")]:IsAvailable()) * 15))) or ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\35\168\100\229\6\141\28\189\120\235\24\139\29", "\226\110\205\16\132\107")]:CooldownRemains() < (v104 * 2)) and (not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\206\208\243\220\79\232\198\194\203\68\234\200", "\33\139\163\128\185")]:IsAvailable() or (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\114\75\23\219\89\91\1\252\69\93\5\213", "\190\55\56\100")]:CooldownRemains() < (v104 * 1.5))))) and (v14:BuffDown(v85.MetamorphosisBuff) or (v14:BuffRemains(v85.MetamorphosisBuff) > v104) or not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\100\170\47\10\31\230\224\69\135\41\16\7\230\225", "\147\54\207\92\126\115\131")]:IsAvailable()) and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\46\40\54\113\8\81\11\25\52\105\31\123\9", "\30\109\81\85\29\109")]:IsAvailable() or not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\214\127\93\162\63\223\232\246\103\81", "\156\159\17\52\214\86\190")]:IsAvailable() or (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\152\234\179\187\171\233\168\176\156\234\169\174\171\238\169", "\220\206\143\221")]:CooldownRemains() > 5) or not v52 or (v10.CombatTime() < 10)) and v14:BuffDown(v85.InnerDemonBuff)) or (v108 < 15))) or (4238 < 87)) then
					if ((2538 == 2538) and v24(v85.EyeBeam, not v15:IsInRange(v31))) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\235\79\7\122\167\132\222\96\12\114\166\174", "\203\184\38\96\19\203")]:IsCastable() and not v14:IsMoving() and v50 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\24\125\96\108\203\56\125\106\111\203\58\118\106\82\207\43\106", "\174\89\19\25\33")]:IsAvailable() and v15:DebuffDown(v85.EssenceBreakDebuff) and (v94 >= 4)) or (3466 > 4520)) then
					if ((v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\63\30\83\87\242\149", "\107\79\114\50\46\151\231")) or v85[LUAOBFUSACTOR_DECRYPT_STR_0("\26\169\187\42\143\55\163\210\56\178\176\45\185\48\176\201\53\181", "\160\89\198\213\73\234\89\215")]:IsAvailable() or (951 >= 1027)) then
						if (v24(v87.SigilOfFlamePlayer, not v15:IsInRange(v31)) or (1369 > 2250)) then
					...
					elseif ((v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\230\204\26\32\41\247", "\70\133\185\104\83")) or (937 > 3786)) then
						if (v24(v87.SigilOfFlameCursor, not v15:IsInRange(40)) or (901 > 4218)) then
			...
			if ((4 == v132) or (1037 > 4390)) then
				if ((1407 <= 1919) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\61\165\47\124\30\138\49\114\0\187\56", "\19\105\205\93")]:IsReady() and v51 and not v14:PrevGCDP(1, v85.VengefulRetreat) and not v14:IsMoving() and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\154\7\203\141\44\170\9\204", "\95\201\104\190\225")]:IsAvailable() and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\155\195\211\193\184\236\205\207\166\221\196", "\174\207\171\161")]:FullRechargeTime() < v85[LUAOBFUSACTOR_DECRYPT_STR_0("\207\242\12\247\253\243\236\240\14\246", "\183\141\158\109\147\152")]:CooldownRemains()) and v14:HasTier(31, 2) and v14:BuffDown(v85.FelBarrage) and not v99) then
					if ((2526 >= 1717) and v24(v85.ThrowGlaive, not v15:IsSpellInRange(v85.ThrowGlaive))) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\200\205\176\238\221\216\209\163\232\197\238", "\174\139\165\209\129")]:IsReady() and v39 and not v98 and not v99 and v14:BuffDown(v85.FelBarrage)) or (3620 <= 2094)) then
					if (v24(v85.ChaosStrike, not v15:IsSpellInRange(v85.ChaosStrike)) or (1723 >= 2447)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\117\10\238\37\95\57\64\37\229\45\94\19", "\118\38\99\137\76\51")]:IsCastable() and not v14:IsMoving() and v50 and (v14:FuryDeficit() >= 30)) or (1199 > 3543)) then
					if ((1617 < 3271) and ((v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\237\42\4\11\12\50", "\64\157\70\101\114\105")) or v85[LUAOBFUSACTOR_DECRYPT_STR_0("\99\167\169\224\21\78\188\181\226\4\69\172\148\234\23\73\164\180", "\112\32\200\199\131")]:IsAvailable())) then
						if ((3085 > 1166) and v24(v87.SigilOfFlamePlayer, not v15:IsInRange(v31))) then
					...
					elseif ((4493 >= 3603) and (v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\185\147\107\224\80\220", "\68\218\230\25\147\63\174"))) then
						if ((2843 <= 2975) and v24(v87.SigilOfFlameCursor, not v15:IsInRange(30))) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\220\73\238\254\123\251\72\231", "\23\154\44\130\156")]:IsCastable() and v46 and (v14:FuryDeficit() >= 40) and not v14:PrevGCDP(1, v85.VengefulRetreat)) or (1989 <= 174)) then
					if (v24(v85.Felblade, not v15:IsSpellInRange(v85.Felblade)) or (209 > 2153)) then
			...
			if ((568 == 568) and (v132 == 0)) then
				if ((4200 == 4200) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\164\188\61\2\64\71\133\132\166\58\4\70", "\233\229\210\83\107\40\46")]:IsCastable() and v37 and v14:BuffUp(v85.InnerDemonBuff) and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\236\71\38\215\8\206\80\34\222\10\210\75\33", "\101\161\34\82\182")]:CooldownRemains() <= (v14:GCD() * 3))) then
					if (v24(v85.Annihilation, not v15:IsSpellInRange(v85.Annihilation)) or (4285 < 1369)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\8\58\247\246\59\57\236\253\12\58\237\227\59\62\237", "\145\94\95\153")]:IsCastable() and v36 and v52 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\219\200\24\215\66\182\249\200", "\215\157\173\116\181\46")]:CooldownDown() and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\16\173\142\208\223\52\185", "\186\85\212\235\146")]:CooldownRemains() < 0.3) and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\231\146\5\251\55\237\93\224\147\19\255\50", "\56\162\225\118\158\89\142")]:CooldownRemains() < (v104 * 2)) and (v10.CombatTime() > 5) and (v14:Fury() >= 30) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\117\11\197\189\54\209\93", "\184\60\101\160\207\66")]:IsAvailable()) or (3520 > 4910)) then
					if ((2842 <= 4353) and v24(v85.VengefulRetreat, not v15:IsInRange(v31), nil, true)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\37\208\140\252\239\193\6\217\176\254\254\213\22\212\150", "\167\115\181\226\155\138")]:IsCastable() and v36 and v52 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\196\39\235\94\119\112\194\231", "\166\130\66\135\60\27\17")]:CooldownDown() and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\109\68\199\97\57\69\94\199\99\53", "\80\36\42\174\21")]:IsAvailable() and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\107\3\36\127\64\19\50\88\92\21\54\113", "\26\46\112\87")]:IsAvailable() and (v10.CombatTime() > 1) and ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\156\48\184\113\177\188\64\150\171\38\170\127", "\212\217\67\203\20\223\223\37")]:CooldownRemains() > 15) or ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\159\158\187\215\180\142\173\240\168\136\169\217", "\178\218\237\200")]:CooldownRemains() < v104) and (not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\146\176\235\223\184\188\229", "\176\214\213\134")]:IsAvailable() or v14:BuffUp(v85.MetamorphosisBuff) or (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\209\180\179\246\173\87\84", "\57\148\205\214\180\200\54")]:CooldownRemains() > (15 + (10 * v27(v85[LUAOBFUSACTOR_DECRYPT_STR_0("\49\228\54\56\115\61\251\29\53\98\0\248\49", "\22\114\157\85\84")]:IsAvailable()))))))) and ((v10.CombatTime() < 30) or ((v14:GCDRemains() - 1) < 0)) and (not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\237\197\26\208\84\247\188\205\221\22", "\200\164\171\115\164\61\150")]:IsAvailable() or (v14:BuffRemains(v85.InitiativeBuff) < v104) or (v10.CombatTime() > 4))) or (3751 < 1643)) then
					if (v24(v85.VengefulRetreat, not v15:IsInRange(v31), nil, true) or (4911 == 3534)) then
				...
				if ((3001 > 16) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\5\87\92\241\252\53\71\94\196\252\39\64\87\247\237", "\153\83\50\50\150")]:IsCastable() and v36 and v52 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\123\115\127\30\127\170\73\88", "\45\61\22\19\124\19\203")]:CooldownDown() and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\232\28\4\225\11\113\173\200\4\8", "\217\161\114\109\149\98\16")]:IsAvailable() and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\55\51\43\121\178\119\23\2\42\121\189\127", "\20\114\64\88\28\220")]:IsAvailable() and (v10.CombatTime() > 1) and ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\20\18\193\177\246\211\184\19\19\215\181\243", "\221\81\97\178\212\152\176")]:CooldownRemains() > 15) or ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\232\244\14\254\20\206\226\63\233\31\204\236", "\122\173\135\125\155")]:CooldownRemains() < (v104 * 2)) and (((v14:BuffRemains(v85.InitiativeBuff) < v104) and not v102 and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\161\216\5\155\58\48\197", "\168\228\161\96\217\95\81")]:CooldownRemains() <= v14:GCDRemains()) and (v14:Fury() > 30)) or not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\255\212\35\83\33\94\216", "\55\187\177\78\60\79")]:IsAvailable() or v14:BuffUp(v85.MetamorphosisBuff) or (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\8\215\90\201\67\206\141", "\224\77\174\63\139\38\175")]:CooldownRemains() > (15 + (10 * v27(v85[LUAOBFUSACTOR_DECRYPT_STR_0("\167\88\91\34\129\78\94\6\133\85\74\43\128", "\78\228\33\56")]:IsAvailable()))))))) and (v14:BuffDown(v85.UnboundChaosBuff) or v14:BuffUp(v85.InertiaBuff))) then
					if ((2875 <= 3255) and v24(v85.VengefulRetreat, not v15:IsInRange(v31), nil, true)) then
				...
				if ((368 < 4254) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\45\232\136\86\232\59\44\23\223\131\69\255\56\56\15", "\89\123\141\230\49\141\93")]:IsCastable() and v36 and v52 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\213\116\250\14\28\75\247\116", "\42\147\17\150\108\112")]:CooldownDown() and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\38\168\36\107\238\233\27\175\59\122", "\136\111\198\77\31\135")]:IsAvailable() and not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\39\26\180\83\179\231\18\139\16\12\166\93", "\201\98\105\199\54\221\132\119")]:IsAvailable() and (v10.CombatTime() > 1) and (v14:BuffDown(v85.InitiativeBuff) or (v14:PrevGCDP(1, v85.DeathSweep) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\148\9\151\32\15\58\190\169\4\140\50\11\38", "\204\217\108\227\65\98\85")]:CooldownUp() and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\125\203\244\234\56\201\93\247\231\228\34\211\88\204\231\232\45\212\87\204\251", "\160\62\163\149\133\76")]:IsAvailable())) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\255\174\4\59\202\215\180\4\57\198", "\163\182\192\109\79")]:IsAvailable()) then
					if (v24(v85.VengefulRetreat, not v15:IsInRange(v31), nil, true) or (4841 <= 2203)) then
				...
				if ((4661 > 616) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\30\3\1\223\45\21\5", "\141\88\102\109")]:IsCastable() and v36 and v47 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\158\92\199\117\20\41\64\204", "\161\211\51\170\16\122\93\53")]:IsAvailable() and (v14:BuffRemains(v85.MomentumBuff) < (v104 * 2)) and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\222\183\183\10\254\175\191", "\72\155\206\210")]:CooldownRemains() <= v104) and v15:DebuffDown(v85.EssenceBreakDebuff) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\100\118\85\10\54\98\123\90\13\54", "\83\38\26\52\110")]:CooldownDown()) then
					if (v24(v85.FelRush, not v15:IsSpellInRange(v85.ThrowGlaive)) or (1943 == 2712)) then
						return LUAOBFUSACTOR_DECRYPT_STR_0("\94\18\43\121\74\2\52\78\24\5\40\82\89\3\46\73\86\87\118\22", "\38\56\119\71");
					end
				end
				v132 = 1;
			end
			if ((4219 >= 39) and (v132 == 5)) then
				if ((3967 > 2289) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\170\221\26\235\173\67\132", "\48\236\184\118\185\216")]:IsCastable() and v36 and v47 and not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\200\178\90\53\193\32\240\176", "\84\133\221\55\80\175")]:IsAvailable() and not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\153\226\41\169\201\126\177\230\32\163\212", "\60\221\135\68\198\167")]:IsAvailable() and (v94 > 1) and v14:BuffDown(v85.UnboundChaosBuff)) then
					if (v24(v85.FelRush, not v15:IsSpellInRange(v85.ThrowGlaive)) or (851 > 2987)) then
				...
				if ((4893 >= 135) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\107\204\80\243\79\28\241\126\201\86\247\70", "\151\56\165\55\154\35\83")]:IsCastable() and not v14:IsMoving() and (v14:FuryDeficit() >= 30) and v15:IsInRange(30)) then
					if ((v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\176\79\4\247\165\81", "\142\192\35\101")) or v85[LUAOBFUSACTOR_DECRYPT_STR_0("\245\122\39\160\226\130\184\4\215\97\44\167\212\133\171\31\218\102", "\118\182\21\73\195\135\236\204")]:IsAvailable() or (3084 > 3214)) then
						if (v24(v87.SigilOfFlamePlayer, not v15:IsInRange(v31)) or (3426 < 2647)) then
					...
					elseif ((v84 == LUAOBFUSACTOR_DECRYPT_STR_0("\160\179\221\217\50\53", "\203\195\198\175\170\93\71\237")) or (1576 == 4375)) then
						if (v24(v87.SigilOfFlameCursor, not v15:IsInRange(30)) or (2920 < 2592)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\86\237\201\172\5\80\91\123\252\193", "\25\18\136\164\195\107\35")]:IsCastable() and v42) or (1110 >= 2819)) then
					if ((1824 <= 2843) and v24(v85.DemonsBite, not v15:IsSpellInRange(v85.DemonsBite))) then
				...
				if ((3062 == 3062) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\11\233\39\232\29\207\138", "\226\77\140\75\186\104\188")]:IsReady() and v36 and v47 and not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\148\193\221\58\65\173\219\221", "\47\217\174\176\95")]:IsAvailable() and (v14:BuffRemains(v85.MomentumBuff) <= 20)) then
					if ((716 <= 4334) and v24(v85.FelRush, not v15:IsSpellInRange(v85.ThrowGlaive))) then
				...
				if ((1001 < 3034) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\252\218\175\181\198\201\215", "\179\186\191\195\231")]:IsReady() and v36 and v47 and not v15:IsInRange(v31) and not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\212\48\21\225\247\43\13\233", "\132\153\95\120")]:IsAvailable()) then
					if (v24(v85.FelRush, not v15:IsSpellInRange(v85.ThrowGlaive)) or (977 > 1857)) then
				...
				if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\214\6\44\238\250\194\245\15\16\236\235\214\229\2\54", "\164\128\99\66\137\159")]:IsCastable() and v36 and v52 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\38\140\229\188\12\136\237\187", "\222\96\233\137")]:CooldownDown() and not v85[LUAOBFUSACTOR_DECRYPT_STR_0("\144\189\174\11\129\242\228\176\165\162", "\144\217\211\199\127\232\147")]:IsAvailable() and not v15:IsInRange(v31)) or (868 > 897)) then
					if (v24(v85.VengefulRetreat, not v15:IsInRange(v31), nil, true) or (1115 == 4717)) then
	...
	local function v121()
		local v136 = 0;
		while true do
			if ((107 <= 4905) and (v136 == 4)) then
				v104 = v14:GCD() + 0.05;
				if (v26.TargetIsValid() or v14:AffectingCombat() or (1004 > 4035)) then
					local v182 = 0;
					while true do
						if ((0 == v182) or (2802 < 369)) then
							v107 = v10.BossFightRemains(nil, true);
							v108 = v107;
							v182 = 1;
						end
						if ((1497 <= 2561) and (v182 == 1)) then
							if ((v108 == 11111) or (816 > 1712)) then
			...
			if ((v136 == 5) or (2733 == 2971)) then
				if ((2599 < 4050) and v32) then
					return v32;
				end
				if ((2034 == 2034) and v72) then
					local v183 = 0;
					while true do
						if ((3040 < 4528) and (v183 == 0)) then
							v32 = v26.HandleIncorporeal(v85.Imprison, v87.ImprisonMouseover, 30, true);
							if (v32 or (2092 <= 2053)) then
								return v32;
							end
							break;
						end
				...
				if ((2120 < 4799) and v26.TargetIsValid() and not v14:IsChanneling() and not v14:IsCasting()) then
					...
					while true do
						if ((v184 == 3) or (4538 <= 389)) then
							...
							if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\148\221\214\71\13\46\199", "\89\210\184\186\21\120\93\175")]:IsCastable() and v36 and v47 and v14:BuffUp(v85.UnboundChaosBuff) and (((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\152\94\113\218\117\59\165\90\115\219\88\47\163\82", "\90\209\51\28\181\25")]:Charges() == 2) and v15:DebuffDown(v85.EssenceBreakDebuff)) or (v14:PrevGCDP(1, v85.EyeBeam) and v14:BuffUp(v85.InertiaBuff) and (v14:BuffRemains(v85.InertiaBuff) < 3)))) or (51 >= 920)) then
								if (v24(v85.FelRush, not v15:IsSpellInRange(v85.ThrowGlaive)) or (2968 <= 1998)) then
						...
						if ((1751 > 1411) and (v184 == 5)) then
							if ((4182 == 4182) and (v76 < v108) and v35) then
								local v189 = 0;
								while true do
									if ((v189 == 0) or (4666 <= 611)) then
										v32 = v116();
										if (v32 or (4737 <= 4525)) then
											return v32;
										end
										break;
									end
							...
							if ((4367 >= 3735) and v14:BuffUp(v85.MetamorphosisBuff) and (v14:BuffRemains(v85.MetamorphosisBuff) < v104) and (v94 < 3)) then
								local v190 = 0;
								while true do
									if ((2426 == 2426) and (v190 == 0)) then
										v32 = v115();
										if ((21 < 1971) and v32) then
											return v32;
										end
										break;
									end
							...
							v32 = v117();
							if (v32 or (2922 <= 441)) then
								return v32;
							end
							v184 = 6;
						end
						if ((3624 >= 1136) and (v184 == 0)) then
							if ((2043 < 2647) and not v14:AffectingCombat()) then
								local v191 = 0;
								while true do
									if ((v191 == 0) or (354 >= 1534)) then
										v32 = v114();
										if (v32 or (3764 >= 4876)) then
											return v32;
										end
										break;
									end
							...
							if ((47 < 1090) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\5\209\120\27\196\229\43", "\150\67\180\20\73\177")]:IsReady() and v36 and v47 and not v15:IsInRange(v31)) then
								if (v24(v85.FelRush, not v15:IsSpellInRange(v85.ThrowGlaive)) or (1371 >= 2900)) then
							...
							if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\227\224\176\35\192\207\174\45\222\254\167", "\76\183\136\194")]:IsReady() and v51 and v13.ValueIsInArray(v109, v15:NPCID())) or (1126 <= 504)) then
								if (v24(v85.ThrowGlaive, not v15:IsSpellInRange(v85.ThrowGlaive)) or (3732 == 193)) then
						...
						if ((3344 >= 3305) and (v184 == 2)) then
							...
							if ((v85[LUAOBFUSACTOR_DECRYPT_STR_0("\240\226\11\81\28\176\37\31\214\225\39\75\2\176", "\118\185\143\102\62\112\209\81")]:IsCastable() and v49 and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\110\113\46\227\163\28\14\61", "\88\60\16\73\134\197\117\124")]:IsAvailable() and (v94 >= 3) and (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\114\230\249\204\68\116\235\246\203\68", "\33\48\138\152\168")]:CooldownDown() or v15:DebuffDown(v85.EssenceBreakDebuff))) or (2885 < 1925)) then
								if (v24(v85.ImmolationAura, not v15:IsInRange(v31)) or (4542 <= 1594)) then
						...
						if ((338 <= 3505) and (v184 == 1)) then
							if ((69 == 69) and v85[LUAOBFUSACTOR_DECRYPT_STR_0("\42\201\178\235\170\85\18\192\169\242\184", "\18\126\161\192\132\221")]:IsReady() and v51 and v13.ValueIsInArray(v109, v16:NPCID())) then
								if (v24(v87.ThrowGlaiveMouseover, not v15:IsSpellInRange(v85.ThrowGlaive)) or (672 == 368)) then
			...
			if ((v136 == 2) or (290 > 2746)) then
				...
				if ((1923 < 4601) and v14:IsDeadOrGhost()) then
					return;
				end
				if (v85[LUAOBFUSACTOR_DECRYPT_STR_0("\8\208\170\96\0\55\216\190\86\6\50\207\175\98\27", "\111\65\189\218\18")]:IsAvailable() or (3957 == 2099)) then
					v31 = 10;
				end
				v136 = 3;
			end
			...
			if ((2359 <= 3733) and (v136 == 3)) then
				v92 = v14:GetEnemiesInMeleeRange(v31);
				v93 = v14:GetEnemiesInMeleeRange(20);
				if (v34 or (4596 <= 2402)) then
					local v186 = 0;
					while true do
						if ((2078 > 163) and (v186 == 0)) then
