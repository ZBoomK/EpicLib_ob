...
-- File Locals
local EventFrame = CreateFrame("Frame", "EpicLib_EventFrame", UIParent)
...
function EL:RegisterForEvent(Handler, ...)
  local EventsTable = { ... }
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:UnregisterForEvent(Handler, Event)
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:RegisterForCombatEvent(Handler, ...)
  local EventsTable = { ... }
  for i = 1, #EventsTable do
    local Event = EventsTable[i]
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:RegisterForSelfCombatEvent(Handler, ...)
  local EventsTable = { ... }
  for i = 1, #EventsTable do
    local Event = EventsTable[i]
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:RegisterForPetCombatEvent(Handler, ...)
  local EventsTable = { ... }
  for i = 1, #EventsTable do
    local Event = EventsTable[i]
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:RegisterForCombatPrefixEvent(Handler, ...)
  local EventsTable = { ... }
  for i = 1, #EventsTable do
    local Event = EventsTable[i]
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:RegisterForCombatSuffixEvent(Handler, ...)
  local EventsTable = { ... }
  for i = 1, #EventsTable do
    local Event = EventsTable[i]
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:UnregisterForCombatEvent(Handler, Event)
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:UnregisterForSelfCombatEvent(Handler, Event)
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:UnregisterForPetCombatEvent(Handler, Event)
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:UnregisterForCombatPrefixEvent(Handler, Event)
...
-- @param Handler The handler function.
-- @param Events The events name.
function EL:UnregisterForCombatSuffixEvent(Handler, Event)
...
EL:RegisterForEvent(function(Event)
